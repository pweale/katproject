...
WebUI.click(findTestObject('Object Repository/Page_Qualifications/input_Add License_name'))

WebUI.setText(findTestObject('Object Repository/Page_Qualifications/input_Add License_name'), ' ')

WebUI.click(findTestObject('Object Repository/Page_Qualifications/a_Save'))

WebUI.click(findTestObject('Object Repository/Page_Qualifications/span_Required'))

WebUI.doubleClick(findTestObject('Object Repository/Page_Qualifications/span_Required'))
...
WebUI.click(findTestObject('Object Repository/Page_Qualifications/span_Already exists'))
