...
WebUI.click(findTestObject('Object Repository/Page_Employee Management/a_Canadian Development Center'))
...
WebUI.click(findTestObject('Object Repository/Page_Personal Details/div__picker__nav--prev'))
...
WebUI.click(findTestObject('Object Repository/Page_Personal Details/span_1976'))

WebUI.click(findTestObject('Object Repository/Page_Personal Details/div_9'))
...
WebUI.setText(findTestObject('Object Repository/Page_Personal Details/input_Nationality_licenseNo'), '456789')

WebUI.click(findTestObject('Object Repository/Page_Personal Details/i_date_range'))

WebUI.click(findTestObject('Object Repository/Page_Personal Details/div__picker__nav--next'))
...
WebUI.click(findTestObject('Object Repository/Page_Personal Details/div_21'))
...
WebUI.click(findTestObject('Object Repository/Page_Job/div_15'))

WebUI.click(findTestObject('Object Repository/Page_Job/i_arrow_drop_down'))

WebUI.click(findTestObject('Object Repository/Page_Job/span_Art Director'))
...
WebUI.click(findTestObject('Object Repository/Page_Job/span_Freelance'))
...
WebUI.click(findTestObject('Object Repository/Page_Job/span_Craft Workers'))
...
WebUI.click(findTestObject('Object Repository/Page_Job/div_29'))

WebUI.click(findTestObject('Object Repository/Page_Job/i_date_range'))

WebUI.click(findTestObject('Object Repository/Page_Job/button_2024'))

WebUI.click(findTestObject('Object Repository/Page_Job/span_2027'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Job/select_197419751976197719781979198019811982_029544'), 
    '2027', true)
