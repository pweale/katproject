...
WebUI.setText(findTestObject('Object Repository/Page_Qualifications/input_Add License_name'), 'Addnewonecancel')

WebUI.click(findTestObject('Object Repository/Page_Qualifications/a_Cancel'))

WebUI.verifyTextNotPresent('Addnewonecancel', true)
