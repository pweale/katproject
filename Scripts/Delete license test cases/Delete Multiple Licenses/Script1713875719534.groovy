...
WebUI.click(findTestObject('Page_Qualifications/label'))

WebUI.click(findTestObject('Page_Qualifications/label2'))
...
WebUI.click(findTestObject('Object Repository/Page_Qualifications/a_Yes, Delete'))
