...
WebUI.setText(findTestObject('Object Repository/Page_Qualifications/input_Add License_name'), languageone)

WebUI.click(findTestObject('Object Repository/Page_Qualifications/a_Save'))

WebUI.click(findTestObject('Object Repository/Page_Qualifications/i_add'))

WebUI.click(findTestObject('Object Repository/Page_Qualifications/em_'))

WebUI.setText(findTestObject('Object Repository/Page_Qualifications/input_Add License_name'), languagetwo)
