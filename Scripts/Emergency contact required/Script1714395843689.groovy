...
WebUI.click(findTestObject('Object Repository/Page_Frank Aaron/a_More  more_vert'))
...
WebUI.click(findTestObject('Object Repository/Page_Frank Aaron/span_Required'))
