...
WebUI.click(findTestObject('Object Repository/Page_Qualifications/i_arrow_upward'))

WebUI.click(findTestObject('Object Repository/Page_Qualifications/i_arrow_downward'))
